...
CRITICAL: Exclude claims that assign cognitive functions or roles to brain regions. Ban phrases like "plays a role in", "subserves", "mediates", "is essential for", "supports", "indicates a pathway for", "is critical for", "is responsible for", "determine the speed of", "is a key structure". Only report direct observations (e.g., activation, deactivation, correlation, difference, increase, decrease).
